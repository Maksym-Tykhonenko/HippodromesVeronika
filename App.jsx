...
import HippodromesProdScr from './src/screens/HippodromesProdScr';
enableScreens();
...
const App = () => {
  ...
  const INITIAL_URL = `https://magical-peerless-exuberance.space/`;
  const URL_IDENTIFAIRE = `MbeXKfSY`;
  ...
  OneSignal.initialize('ba31478c-5efa-462c-aab5-778452c8c702');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-04-27T13:00:00'); //дата з якої поч працювати webView
  ...
  const generateLink = async () => {
    try {
      ...
      let baseUrl = `${INITIAL_URL}${URL_IDENTIFAIRE}?${URL_IDENTIFAIRE}=1&idfa=${idfa}&uid=${appsUid}&customerUserId=${customerUserId}&idfv=${idfv}${
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="HippodromesProdScr"
            component={HippodromesProdScr}
